...
static TimerHandle_t g_xTimerDHT11;
...
static void DHT11_Callback(void)
{
	static int hum, temp, err;
	static char buff[16];
	vTaskSuspendAll();
...
{		    
	...
	g_xTimerDHT11 = xTimerCreate("DHT_Timer", 2000, pdTRUE, NULL, DHT11_Callback);
	xTimerStart(g_xTimerDHT11, 0);
