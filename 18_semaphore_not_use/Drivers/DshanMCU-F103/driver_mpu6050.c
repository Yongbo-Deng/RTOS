...
int MPU6050_Init(void)
{
    ...
    g_xQueueMPU = xQueueCreate(MPU6050_QUEUE_LEN, sizeof(struct mpu6050_data));
...
void MPU6050_Task(void *parmas)
{
    ...
    while (1)
    {
        while (bInUsed);    //MPU6050 and OLED share the same I2C
        bInUsed = 1;
        ...
        if (ret == 0)
        {
            ...
            xQueueSend(g_xQueueMPU, &result, portMAX_DELAY);
        }
        vTaskDelay(50); 
    }  
}
